...
# Preload images
BLACK_PIECE_SURFACE = pygame.image.load("images/ronaldo.png")
WHITE_PIECE_SURFACE = pygame.image.load("images/messi.png")
...
BOARD = pygame.image.load("images/glass.png")
