...
class HomePage(ScreenBase, CardMixin):
    def __init__(self, screen):
        ...
        self._buttons = [self.btn_player,self.btn_settings, self.btn_logout]
...
class Screen:
    def __init__(self, size: tuple[int, int] = (WIDTH, HEIGHT)):
        ...
        self._screens: dict[str, ScreenBase] = {
            ...
            MODE_SETTINGS: SettingsPage(self),  # <-- added so settings works
        }
    ...
    # Switch screen mode between login, signup, main page, settings
